            ...
            <div className="tree-card card shadow mb-4 p-4">
              ...
              <div className="row g-3">
                <div className="col-6 param-col">
                  ...
                  <div className="param-text">
                    <span className="param-value">{temperature}</span><span className="param-unit">°C</span>
                  </div>
                  <div className="param-label">Nhiệt độ</div>
                </div>
                ...
                <div className="col-6 param-col">
                  ...
                  <div className="param-text">
                    <span className="param-value">{humidity}</span><span className="param-unit">%</span>
                  </div>
                  <div className="param-label">Độ ẩm</div>
                </div>
                ...
                <div className="col-6 param-col">
                  ...
                  <div className="param-text">
                    <span className="param-value">{soilMoisture}</span><span className="param-unit">%</span>
                  </div>
                  <div className="param-label">Soil</div>
                </div>
                ...
                <div className="col-6 param-col">
                  ...
                  <div className="param-text">
                    <span className="param-value">{lightLevel}</span><span className="param-unit">lx</span>
                  </div>
                  <div className="param-label">Ánh sáng</div>
                </div>
              </div>
