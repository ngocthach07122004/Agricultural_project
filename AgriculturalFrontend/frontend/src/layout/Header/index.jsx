...
const Header = () => {
  ...
  return (
    <>
          ...
          <div className="d-flex gap-3 align-items-center">
            ...
            {!isLoggedIn ? (
              <span className="text-danger">
                ...
                /
                <a onClick={() => navigate("/signin")} className="auth-link">
                  ĐĂNG NHẬP
                </a>
              </span>
            ) : (
              <div className="d-flex gap-3">
                ...
                <span className="text-danger">
                  <a onClick={() => navigate("/profile")} className="auth-link">
                    {userName}
                  </a>{" "}
                  /
                  <a
      ...
      <nav
        className="main-nav navbar navbar-expand-lg"
        style={{ background: "var(--primary_background)" }}
      >
        <div className="container-fluid">
          {/* Mobile Menu Button */}
          <button
